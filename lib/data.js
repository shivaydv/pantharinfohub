...
export const users = [
    ...
    },
    {
        ...
        quote: "Abhishek Pal, Co-founder and CMO of Panthar Infohub Pvt. Ltd., combines technical expertise with innovative marketing. A B.Tech student at AKTU, Lucknow, he drives data-driven strategies to empower businesses and shape a smarter, safer future.",
        socials: [
            {
                icon: <Linkedin className="text-white size-5" />,
...
export const services = [
    {
        title: "Discovery",
        image: discovery,
        descriptiom: "We conduct in-depth research and analysis to grasp your needs, challenges, and objectives. This rigorous process ensure as strong foundation for developing precise, high-impact solutions.",
    },
    {
        title: "Design",
        image: design,
        descriptiom: "Our design team specializes in creating visually striking and intuitively seamless experiences. From UI/UX to branding, we meticulously craft designs that not only capture attention but also establish a meaningful connection with your target audience, ensuring lasting engagement and impact.",
    },
    {
        title: "Development",
        image: dev,
...
export const projects = [
    {
        ...
        description: "In danger? Lost? Need help? We’ve got you.Suraksha Kawach connects you to guardians, volunteers, and emergency services—instantly",
        btn: {
            text: "Check Program",
...
export const dummyCarrer = [
    ...
    },
    {
        ...
        "description": "We are looking for a Mobile Engineer with expertise in Android or iOS development",
        "location": "On Site",
        "type": "Full Time",
    ...
    },
    {
        ...
        "description": "We are looking for a Backend Developer to design and maintain scalable server-side applications",
        "location": "On Site",
        "type": "Full Time",
    ...
    },
    {
        ...
        "description": "We are looking for a Marketing Head to lead our digital and brand marketing strategies",
        "location": "Hybrid",
        "type": "Full Time",
...
export const testimonials = [
    {
        name: "Raj Sharma",
        role: "Student",
        image: "https://plus.unsplash.com/premium_photo-1682091992663-2e4f4a5534ba?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8aW5kaWFuJTIwc3R1ZGVudHxlbnwwfHwwfHx8MA%3D%3D",
        rating: 5,
    ...
    },
    {
        ...
        image: "https://img.freepik.com/premium-photo/indian-college-student-standing-with-bag-reading-book-white-background_75648-5434.jpg",
        rating: 5,
    ...
    },
    {
        ...
        image: "https://media.istockphoto.com/id/1369754239/photo/university-student-in-white-background-stock-photo.jpg?s=612x612&w=0&k=20&c=LjFVDfjusWBjYTNliHV9DyXfApPGc8DmgBGEtfVgQ0Q=",
        rating: 5,
